...
###
👨🏻‍💻 Tenho experiência realizando análises diagnósticas, preditivas e consultas complexas de dados utilizando Python, SQL, Excel, desenvolvimento de processos de ETL, plataformas de Business Intelligence(BI) como PowerBI ou Metabase para criar visualizações personalizadas e impactantes com o objetivo de comunicar descobertas de forma clara e acessível.
