...
###
👨🏻‍💻 Tenho experiência em analises e consultas complexas de dados utilizando Python, SQL, Excel, uso da ferramenta Pentaho para elaboração de ETL, plataformas de Business Intelligence(BI) como PowerBI ou Metabase para criar visualizações personalizadas e impactantes com o objetivo de comunicar descobertas de forma clara e acessível.
