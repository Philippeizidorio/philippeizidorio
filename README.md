...
Sou Acadêmico em Ciência De Dados pelo Centro Universitário Estácio de Sergipe, aluno da formação em Data Science pela Escola DNC e apaixonado por transformar dados em informações relevantes. Atuei como Analista de Business Intelligence na área pedagógica-administrativa por mais de 3 anos, com vivência prática na aplicação da inteligência de negócios, fornecendo insights estratégicos com foco em resolução de problemas, otimização de processos, resultados e apoio na tomada de decisões. 
